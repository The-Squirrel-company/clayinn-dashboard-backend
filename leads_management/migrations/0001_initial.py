    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('venue_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leads', to='venue_management.venue')),
            ],
        ),
        migrations.CreateModel(
            name='Haldi',
            fields=[
                ...
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='haldis', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='engagements', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='corporates', to='bookings_management.booking')),
                ('lead', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='corporates', to='leads_management.lead')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mehndis', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='receptions', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rokas', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquor_value', models.IntegerField(blank=True, null=True)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sagans', to='bookings_management.booking')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='weddings', to='bookings_management.booking')),
